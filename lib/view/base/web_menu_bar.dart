  ...
  if (await canLaunch(url)) {
    ...
    return Center(child: Container(
      ...
      child: Row(children: [
        ...
        SizedBox(width: 20),
        GestureDetector(
  child: Text("Join as Restaurant   ", style: TextStyle(decoration: TextDecoration.none, color: Color.fromARGB(255, 0, 0, 0))),
  onTap: () async {
  const url = 'https://dollartum.com/admin/restaurant-panel/auth/login';
...
void Linkify({Null Function(dynamic link) onOpen}) {
}
...
class MenuButton extends StatelessWidget {
  ...
  MenuButton({@required this.icon, @required this.title, this.isCart = false, @required this.onTap, recognizer});
